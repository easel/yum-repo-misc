...
install -D -m 644 dist/pip-%{version}.tar.gz %{buildroot}/%{python3_sitelib}/virtualenv_support/pip-%{version}.tar.gz
...
%files virtualenv
%attr(644,root,root) %{python3_sitelib}/virtualenv_support/pip-%{version}.tar.gz
