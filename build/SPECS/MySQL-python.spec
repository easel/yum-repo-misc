...
%dir %{?scl:%{_scl_root}}/usr/%{_lib}/python?.?/site-packages/MySQLdb/constants

%changelog
* Tue May 07 2013 Bohuslav Kabrda <bkabrda@redhat.com> - 1.2.3-9
- Rebuild to generate bytecode properly after fixing rhbz#956289

* Thu Apr 18 2013 Matej Stuchlik <mstuchli@redhat.com> - 1.2.3-8
- Rebuilt for PPC
