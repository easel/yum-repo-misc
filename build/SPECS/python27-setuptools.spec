...
# https://bitbucket.org/tarek/distribute/changeset/8d053cd2bf8ef25501afd2d50825b8168c62b2d4
Patch1: distribute-fix-test-links-priority.patch
# Patch to make easy_install usable while fips mode on
Patch2: distribute-md5-fix-for-fips.patch
# Add ssl support for downloading packages trough https with easy_install
Patch3: distribute-add-ssl.patch
