...
Patch2:         nose-python-3-doc-build.patch
# All these patches were created by git show XXX, so if you need to find
# them upstream, just see their commit hashes and search by them
Patch3:         nose-test-race-condition-fix.patch
Patch4:         nose-make-test_multiprocessing-reliable.patch
Patch5:         nose-fix-infinite-recursion-on-python33.patch
Patch6:         nose-fix-python33-doctest-elipsis.patch
Patch7:         nose-shunt-result-of-test-cases-on-python33.patch
