...
%if %{with_zts}
ln -s %{_httpd_moddir}/libphp5-zts.so  $RPM_BUILD_ROOT%{_root_httpd_moddir}/lib%{name}5-zts.so
%endif
%endif
sed -e 's/libphp/lib%{name}/' %{SOURCE9} >modconf
...
%if %{with_zts}
%{_root_httpd_moddir}/lib%{name}5-zts.so
%endif
%endif
