%{?scl:%scl_package c-ares}
%{!?scl:%global pkg_name %{name}}

Summary: A library that performs asynchronous DNS operations
Name: %{?scl_prefix}c-ares
Version: 1.9.1
Release: 5.1%{?dist}
License: MIT
...
Source1: LICENSE
Patch0: %{pkg_name}-1.7.5-optflags.patch
...
%changelog
* Thu May 09 2013 Stanislav Ochotnicky <sochotnicky@redhat.com> - 1.9.1-5.1
- Add runtime dependency on scl-runtime

* Fri Apr 05 2013 Stanislav Ochotnicky <sochotnicky@redhat.com> - 1.9.1-5
